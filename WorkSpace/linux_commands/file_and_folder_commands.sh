...
echo -e  "${BRed}Welcome to the file and directory management command guide!${RESET}"
...
example "mkdir -p parent/dir1/dir2/dir3 # Create nested directories (parent directories if needed)."
...
note "If the destination file already exists, it will be overwritten by default."
example "mv oldname.txt newname.txt # Rename a file."
example "mv dir1 /new/path/dir1      # Move a directory."
note "Use 'mv -i' to ask for confirmation before overwriting files."
echo
